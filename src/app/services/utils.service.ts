...
//   errorAPIMsgAlertHandler(resObj, showAlert = false) {
...
//   encodeStringToBase64(param) {
//     param = param.toString();
//     if (param.match(/\w{2}/g)) {
//       return btoa(param.match(/\w{2}/g).map((a) => {
...
//   mergeKeys(arr, key1, key2, newKey) {
...
//       localStorage.getItem('disabledPermissions') || [];
...
//   searializeUrl(routePath, params: any) {
